...
import { WalletButtonGroup } from "@common-module/wallet";
...
export default class WalletLoginModal extends StructuredModal {
    ...
    async handleLogin(walletConnector) {
        ...
        const { nonce, issuedAt } = await WalletAPIService.generateWalletLoginNonce(walletAddress);
        ...
        const token = await WalletAPIService.walletLogin(walletAddress, signedMessage);
